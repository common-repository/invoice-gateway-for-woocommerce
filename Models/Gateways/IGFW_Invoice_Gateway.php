...
class IGFW_Invoice_Gateway extends \WC_Payment_Gateway {
    ...
    public function process_payment($order_id) {
        ...
        $order->update_status(
            apply_filters( 'igfw_invoice_gateway_process_payment_order_status', get_option( 'igfw_default_order_status', 'on-hold' ), $order ),
            __( 'Payment to be made upon invoice.', 'invoice-gateway-for-woocommerce' )
        );
